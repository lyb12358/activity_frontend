...
module.exports = configure(function (ctx) {
  return {
    ...
    build: {
      ...
      env: {
        API: ctx.dev
          ? 'http://11.20.5.217:9090'
          : 'https://map.beyond-itcenter.com/activity_backend'
        // API: ctx.dev
        //   ? 'https://map.beyond-itcenter.com/activity_backend'
        //   : 'http://11.0.5.4:9090'
      },
    ...
    pwa: {
      ...
      manifest: {
        name: `Activity`,
        short_name: `Activity`,
        description: `A Project to make an appointment`,
        display: 'standalone',
